...
@Component({
  selector: 'app-favorite-series',
  templateUrl: './favorite-series.component.html',
  styleUrls: ['./favorite-series.component.css']
})
export class FavoriteSeriesComponent implements OnInit {
  ...
  constructor() { 
    this.series = [
      ...
      {
        name: "Dopesick (Miniserie de TV) (2021)"
      },

      {
        name: "Time (Miniserie de TV) (2021)"
      },

      {
        name: "Las cosas por limpiar (Miniserie de TV) (2021)"
      },

      {
        name: "El código de la discordia (Miniserie de TV) (2021"
      },

      {
        name: "Mudanzas al cielo (Serie de TV) (2021)"
      },

      {
        name: "Dr. Stone: Stone Wars (Serie de TV) (2021)"
      },

      {
        name: "Manhunt: The Night Stalker (Miniserie de TV) (2021)"
      },

      {
        name: "Utmark (Serie de TV) (2021)"
      }
